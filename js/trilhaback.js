...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const stepDetails = {
        BasicoBack: {
            title: "Oque acontece por trás de todo site?",
            content: `
                <p>um desenvolvedor BackEnd deve conhecer sobre as principais funcionalidades que ocorrem por trás de todo sistema</p>
                <h4>Funcionalidades principais:</h4>
                <ul>
                    <li><strong>BackEnd:</strong> Como os dados introduzidos no site serão organizados e armazenados.</li>
                    <li><strong>Linkagem entre front:</strong> como o sistema irá se integrar as funcionalidades da pagina html.</li>
                </ul>
